...
public class Game1 : InstanceGame
{
    ...
    // 鼠标光标类型定义
    public static readonly int cursor_none;         // 不显示鼠标光标
    public static readonly int cursor_default;      // 默认光标
    public static readonly int cursor_wait;         // 等待状态光标
    public static readonly int cursor_grab;         // 抓取物品的光标
    public static readonly int cursor_gift;         // 表示可以给NPC送礼物的光标
    public static readonly int cursor_talk;         // 表示可以与NPC对话的光标
    public static readonly int cursor_look;         // 表示可以查看某个对象的光标
    public static readonly int cursor_harvest;      // 表示可以收获的光标
    public static readonly int cursor_gamepad_pointer; // 用于手柄控制的光标
    ...
    // 玩家当前实例
    private static Farmer _player;  // 当前玩家对象
    ...
    // 游戏运行时的静态字段
    // 游戏中的各种天气状态
    public static bool isRaining;// 是否正在下雨
    public static bool isSnowing;// 是否正在下雪
    public static bool isLightning;     // 当前是否有闪电
    public static bool isDebrisWeather; // 当前是否有风吹残骸天气
    ...
    // 游戏的音效管理
    public static IAudioCategory musicCategory;   // 音乐类别
    public static IAudioCategory soundCategory;   // 音效类别
    public static IAudioCategory ambientCategory; // 环境音效类别
    public static IAudioCategory footstepCategory; // 脚步音效类别
    ...
    {// 重置工具贴图的逻辑
        if (_toolSpriteSheet != null)
		{
			_toolSpriteSheet.Dispose();// 释放之前的资源
		...
		_toolSpriteSheet = texture2D;// 更新工具贴图
    }
